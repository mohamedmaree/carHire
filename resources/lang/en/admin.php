...
return [
    ...
    "image"                                                  => "Image",
    "app_setting"                                            => "Application Information ",
    ...
    "at_least_one_permission_required"                        => "At least one permission must be selected",
    "sort_by"                                                => "sort by",
    ...
    'holiday_days' => 'Days off',
    'holiday_hours' => 'Hours off',
    ...
    'our_location_location' => 'Our Location',
    ...
    'delete_confirmation_title' => 'Do you want to continue?',
    'delete_confirmation_text' => 'Are you sure you want to complete the deletion process?',
    'delete_selected_confirmation_text' => 'Are you sure you want to complete the deletion of the selected items?',
    ...
    'address' => 'Address',
    'caption' => 'Caption',
    'toll_delivery_fees' => 'Delivery Fees',
    'fees' => 'Fees',
    'city' => 'City',
    'country' => 'Country',
    'driver_license_number' => 'Driver License Number',
    ...
    'view_file' => 'View File',
    'terms_file' => 'Terms and Conditions File',
    'privacy_file' => 'Privacy Policy File',
    'name_title_car' => 'Car Name',
    'gst' => 'GST',
    'refundable_deposit' => 'Refundable Deposit',
    'surcharges_fee' => 'Surcharges Fee',
    'order_pricing_settings' => 'Order Pricing Settings',
    'gst_percentage' => 'GST Percentage (%)',
    'gst_percentage_hint' => 'Percentage of subtotal (e.g., 10 for 10%)',
    'gst_rate' => 'GST Rate',
    'gst_rate_hint' => 'Fixed number used to calculate GST from subtotal. Formula: GST = subtotal / gst_rate. The subtotal already includes GST (e.g., if subtotal is $110 and GST rate is 10, then GST = $110 / 10 = $11)',
    'refundable_deposit_hint' => 'Fixed amount in dollars (e.g., 500)',
    'surcharges_fee_percentage' => 'Surcharges Fee Percentage (%) - Default Country',
    'surcharges_fee_percentage_hint' => 'Surcharges fee percentage for customers from the default country. Applied to: (subtotal + refundable_deposit - coupon_discount) (e.g., 1.5 for 1.5%)',
    'external_surcharges_fee_percentage' => 'Surcharges Fee Percentage (%) - External Countries',
    'external_surcharges_fee_percentage_hint' => 'Surcharges fee percentage for customers from countries other than the default country. Applied to: (subtotal + refundable_deposit - coupon_discount) (e.g., 3.7 for 3.7%)',
