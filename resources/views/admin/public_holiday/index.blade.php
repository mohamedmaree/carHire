...
<x-admin.table 
    ...
    order="true" 
    extrabuttons="true"
    addbutton="{{ route('admin.public-holidays.create') }}"
    deletebutton="{{ route('admin.public-holidays.deleteAll') }}"
    :searchArray="[
        'name' => [
            'input_type' => 'text' , 
            'input_name' => __('admin.public_holiday_name') , 
        ] ,
        'year' => [
            'input_type' => 'number' , 
            'input_name' => __('admin.year') , 
        ] ,
        'is_active' => [
            'input_type' => 'select' , 
            'rows'       => [
...
@section('js')
    ...
    @include('admin.shared.filter_js' , [ 'index_route' => route('admin.public-holidays.index') ])
@endsection
