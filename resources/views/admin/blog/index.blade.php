...
<x-admin.table 
    ...
    order="true" 
    extrabuttons="true"
    addbutton="{{ route('admin.blogs.create') }}"
    deletebutton="{{ route('admin.blogs.deleteAll') }}"
    :searchArray="[
        'title' => [
            'input_type' => 'text' , 
...
@section('js')
    ...
    @include('admin.shared.filter_js' , [ 'index_route' => route('admin.blogs.index') ])
@endsection
