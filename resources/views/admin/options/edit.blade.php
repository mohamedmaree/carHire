...
@section('content')
<form method="POST" action="{{route('admin.options.update', $option->id)}}" class="store form-horizontal" novalidate>
                                                                                        ...
                                                                                        <div role="tabpanel" class="tab-pane fade @if($loop->first) show active @endif" id="first_{{$lang}}" aria-labelledby="first_{{$lang}}" aria-expanded="true">
                                                                                            <div class="col-md-12 col-12">
                                                                                                <div class="form-group">
                                                                                                    ...
                                                                                                    <div class="controls">
                                                                                                        <input type="text" name="name[{{$lang}}]" class="form-control" placeholder="{{__('admin.write') . __('admin.name')}} {{ $lang }}" value="{{ $option->getTranslation('name', $lang) }}" required data-validation-required-message="{{__('admin.this_field_is_required')}}">
                                                                                                    </div>
                                                                                                </div>
                                                                                            </div>
                                                                                            <div class="col-md-12 col-12">
                                                                                ...
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <div class="controls">
                                                                                        <select name="price_type"
                                                                                            ...
                                                                                            <option value="per_day" {{ $option->price_type == 'per_day' ? 'selected' : '' }}>{{ __('admin.per_day') }}</option>
                                                                                            <option value="flat_fee" {{ $option->price_type == 'flat_fee' ? 'selected' : '' }}>{{ __('admin.flat_fee') }}</option>
                                                                                        </select>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                                    ...
                                                                                    <div class="controls">
                                                                                        <select name="parent_id"
                                                                                            ...
                                                                                            @foreach($parentOptions as $parent)
                                                                                                <option value="{{ $parent->id }}" {{ $option->parent_id == $parent->id ? 'selected' : '' }}>{{ $parent->name }}</option>
                                                                                            @endforeach
                                                                                        </select>
                                                                                    </div>
                                                                                </div>
                                                                                ...
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <div class="controls">
                                                                                        <select name="is_parent"
                                                                                                class="select2 form-control"
                                                                                                id="is_parent_option">
                                                                                            <option value="0" {{ !$option->is_parent ? 'selected' : '' }}>{{ __('admin.child_option') }}</option>
                                                                                            <option value="1" {{ $option->is_parent ? 'selected' : '' }}>{{ __('admin.parent_option') }}</option>
                                                                                        </select>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                                ...
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <div class="controls">
                                                                                        <select name="is_active"
                                                                                                ...
                                                                                                required
                                                                                                data-validation-required-message="{{ __('admin.this_field_is_required') }}">
                                                                                            <option value="1" {{ $option->is_active ? 'selected' : '' }}>{{ __('admin.activate') }}</option>
                                                                                            <option value="0" {{ !$option->is_active ? 'selected' : '' }}>{{ __('admin.dis_activate') }}</option>
                                                                                        </select>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                                ...
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <div class="controls">
                                                                                        <select name="quantity_required"
                                                                                                ...
                                                                                                required
                                                                                                data-validation-required-message="{{ __('admin.this_field_is_required') }}">
                                                                                            <option value="0" {{ !$option->quantity_required ? 'selected' : '' }}>{{ __('admin.no_quantity') }}</option>
                                                                                            <option value="1" {{ $option->quantity_required ? 'selected' : '' }}>{{ __('admin.quantity_required') }}</option>
                                                                                        </select>
                                                                                ...
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <div class="controls">
                                                                                        <select name="is_required"
                                                                                                ...
                                                                                                required
                                                                                                data-validation-required-message="{{ __('admin.this_field_is_required') }}">
                                                                                            <option value="0" {{ !$option->is_required ? 'selected' : '' }}>{{ __('admin.optional') }}</option>
                                                                                            <option value="1" {{ $option->is_required ? 'selected' : '' }}>{{ __('admin.required') }}</option>
                                                                                        </select>
