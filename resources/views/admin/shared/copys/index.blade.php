...
<x-admin.table 
    ...
    order="true" 
    extrabuttons="true"
    addbutton="{{ route('admin.modelKebabPluralName.create') }}"
    deletebutton="{{ route('admin.modelKebabPluralName.deleteAll') }}"
    :searchArray="[
        'name' => [
            'input_type' => 'text' , 
        ...
        {{-- 'country_id' => [
            'input_type' => 'select' , 
            'rows'       => $countries , 
            'input_name' => __('admin.country.index') ,
        ] ,
...
@section('js')
    ...
    @include('admin.shared.filter_js' , [ 'index_route' => route('admin.modelKebabPluralName.index') ])
@endsection
