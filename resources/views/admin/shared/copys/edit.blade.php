...
@section('content')
    ...
    <form method="POST" action="{{route('admin.modelKebabPluralName.update' , ['modelSnakeCase' => $modelSnakeCase->id])}}" class="store form-horizontal" novalidate>
                                                                                            ...
                                                                                            <div role="tabpanel" class="tab-pane fade @if($loop->first) show active @endif " id="first_{{$lang}}" aria-labelledby="first_{{$lang}}" aria-expanded="true">
                                                                                                <div class="col-md-12 col-12">
                                                                                                    <div class="form-group">
                                                                                                        ...
                                                                                                        <div class="controls">
                                                                                                            <input type="text" value="{{$modelSnakeCase->getTranslations('name')[$lang]??''}}" name="name[{{$lang}}]" class="form-control" placeholder="{{__('admin.write') . __('admin.name')}} {{ $lang }}" required data-validation-required-message="{{__('admin.this_field_is_required')}}" >
                                                                                                        </div>
                                                                                                    </div>
                                                                                                </div>
                                                                                            </div>
                                                                                    ...
                                                                                    <div class="form-group">
                                                                                        <div class="controls">
                                                                                            ...
                                                                                            <textarea
                                                                                                    ...
                                                                                                    name="title" id=""
                                                                                                    cols="30" rows="10"
                                                                                                    placeholder="{{__('admin.about_the_application_in_english')}}">{{$modelSnakeCase->title}}</textarea>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                                        ...
                                                                                        <div class="controls">
                                                                                            <select name="role_id" class="select2 form-control" required data-validation-required-message="{{__('admin.this_field_is_required')}}" >
                                                                                                ...
                                                                                                @foreach ($roles as $role)
                                                                                                    <option {{$role->id == $modelSnakeCase->role_id ? 'selected' : ''}} value="{{$role->id}}">{{$role->name}}</option>
                                                                                                @endforeach
                                                                                            </select>
                                                                                        </div>
                                                                                    </div>
