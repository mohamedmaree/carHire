    ...
    <table class="table " id="tab">
        ...
        @foreach ($copys as $copy)
            <tr class="delete_row">
                ...
                <td><img src="{{$copy->image}}" width="30px" alt=""></td>
