    ...
    <table class="table " id="tab">
        ...
        @foreach($images as $image)
            <tr class="delete_image">
                ...
                <td><img src="{{$image->image}}" width="30px" alt=""></td>
                <td>{{ $image->name }}</td>
