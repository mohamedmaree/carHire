...
@section('content')
<form  method="POST" action="{{route('admin.apphomes.update' , ['apphome' => $apphome->id])}}" class="store form-horizontal" novalidate>
                                                                ...
                                                                <div class="form-body">
                                                                    <div class="row">
                                                                        ...
                                                                        {{--  to create languages tabs uncomment that --}}
                                                                            ...
                                                                            <div class="col-md-12 col-12 date">
                                                                                <div class="form-group">
                                                                            ...
                                                                            <div class="col-md-12 col-12 grid_columns_count">
                                                                                <div class="form-group">
                                                                            ...
                                                                            <div class="col-md-12 col-12 records">
                                                                            <div class="form-group">
