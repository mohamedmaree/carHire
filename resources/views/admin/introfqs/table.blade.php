        ...
        @foreach($fqss as $fqs)
            <tr class="delete_fqs">
                ...
                <td class="product-action">
                    @can('read-intro-fqs')
                        <span class="text-primary"><a href="{{ route('admin.introfqs.show', ['introfq' => $fqs->id]) }}"
                    ...
                    @can('update-intro-fqs')
                        <span class="action-edit text-primary"><a
                                    href="{{ route('admin.introfqs.edit', ['introfq' => $fqs->id]) }}"
                    ...
                    @can('delete-intro-fqs')
                        <span class="delete-row btn btn-danger btn-sm"
                              data-url="{{ url('admin/introfqs/' . $fqs->id) }}"><i class="feather icon-trash"></i>{{ __('admin.delete') }}</span>
                    @endcan
                </td>
            </tr>
        @endforeach
