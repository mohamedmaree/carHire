<div class="tab-pane fade active show" id="data">
        ...
        <div class="form-group">
            ...
            <div class="row">
                <div class="col-md-8 col-12">
                    <div class="controls">
                        <input type="number" name="phone" value="{{$row->phone ?? __('admin.not_provided')}}"  class="form-control" placeholder="{{__('admin.enter_phone_number')}}" data-validation-number-message="{{__('admin.the_phone_number_ must_not_have_charachters_or_symbol')}}"  disabled>
                    </div>
                </div>
    ...
    <div class="col-md-12 col-12">
        <div class="form-group">
            ...
            <div class="controls">
                <input type="date" name="birth_date" value="{{$row->birth_date}}" class="form-control" placeholder="{{__('admin.enter_birth_date')}}" required data-validation-required-message="{{__('admin.this_field_is_required')}}" disabled>
            </div>
        </div>
    </div>
