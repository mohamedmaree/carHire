...
<x-admin.table 
    ...
    order="true" 
    extrabuttons="true"
    addbutton="{{ route('admin.locations.create') }}"
    deletebutton="{{ route('admin.locations.deleteAll') }}"
    :searchArray="[
        'name' => [
            'input_type' => 'text' , 
        ...
        'type' => [
            ...
            'rows'       => [
              '1' => [
                'name' => __('admin.airport') , 
                'id' => 'airport' , 
              ],
              '2' => [
                'name' => __('admin.location_type') , 
                'id' => 'location' , 
              ],
            ] , 
...
@section('js')
    ...
    @include('admin.shared.filter_js' , [ 'index_route' => route('admin.locations.index') ])
@endsection
