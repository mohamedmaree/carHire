        ...
        <div class="authentication-inner py-4">
          ...
          <div class="card" style="direction: {{ lang() == 'ar' ? 'rtl':'ltr' }};">
            <div class="card-body">
              ...
              <!-- /Logo -->
              <h4 class="mb-1 pt-2">{{ __('admin.forget_password') }} 🔒</h4>
              <p class="mb-4">{{ __('admin.forget_password_text') }}</p>

              <form id="formAuthentication" class="mb-3" action="{{route('admin.forget-password')}}"  method="POST">
                @csrf
                <div class="mb-3">
                ...
                <div class="mb-3">
                  <button class="btn btn-primary d-grid w-100 submit_button" type="submit">{{__('admin.send_code')}}</button>
                </div>
              </form>
                ...
                $.ajax({
                    ...
                    success: function(response){
                        ...
                        if (response.status == 'success'){
                            ...
                            $(".submit_button").html(`<i class="ft-unlock"></i> {{ __('admin.send_code') }}`).attr('disabled',false)
                    ...
                    error: function (xhr) {
                        $(".submit_button").html("{{ __('admin.send_code')}}").attr('disabled',false)
                        $(".text-danger").remove()
