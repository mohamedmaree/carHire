        ...
        <div class="content-body">
            <section class="row flexbox-container">
                <div class="col-xl-12 d-flex justify-content-center">
                    <div class="card bg-authentication rounded-0 mb-0 w-75">
                ...
                $.ajax({
                    ...
                    success: function(response){
                        ...
                        if (response.status == 'login'){
                            ...
                            $(".submit_button").html(`<i class="ft-unlock"></i> {{ __('admin.login') }}`).attr('disabled',false)
                    ...
                    error: function (xhr) {
                        $(".submit_button").html("{{ __('admin.login')}}").attr('disabled',false)
                        $(".text-danger").remove()
                        $('.form-horizontal input').removeClass('border-danger')
