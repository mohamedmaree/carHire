            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">{{__('admin.role.edit')}}</h4>
                    </div>
                    <div class="card-content">
                        <div class="card-body">
                            <form class="card-body form validated-form" method="POST"
                                  action="{{route('admin.roles.update' , ['role' => $row->id])}}" novalidate>
                                @csrf
                                @method('PUT')
                                ...
                                <div class="row g-3">
                                    <div class="col-md-6 col-6">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" value="{{$row->getTranslations('name')['ar']??''}}"
                                    ...
                                    <div class="col-md-6 col-6">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" value="{{$row->getTranslations('name')['en']??''}}"
                                            ...
                                            <div class="card h-100">
                                                <div class="card-header d-flex justify-content-between mb-3"
                                                    ...
                                                    <div class="card-title mb-0">
                                                        <h5 class="mb-2">@lang('admin.' .  strtolower($title).'.index')</h5>
                                                    </div>
                                                    <label class="switch switch-success">
                                                        <input id="{{ strtolower($title) }}" type="checkbox"
                                                               class="switch-input roles-parent">
                                                ...
                                                <div class="card-body">
                                                    @foreach($permission as $key => $value)
                                                        <ul class="list-unstyled mb-0" style="width: 90% !important;">
                                ...
                                <div class="col-12 d-flex justify-content-center mt-3">
                                    <button type="submit"
                                            class="btn btn-primary mr-1 mb-1 submit_button waves-effect waves-light text-white">{{__('admin.update')}}</button>
