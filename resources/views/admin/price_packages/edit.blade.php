...
@section('content')
<form method="POST" action="{{route('admin.price-packages.update', $pricePackage->id)}}" class="store form-horizontal" novalidate>
                                                                                        ...
                                                                                        <div role="tabpanel" class="tab-pane fade @if($loop->first) show active @endif" id="first_{{$lang}}" aria-labelledby="first_{{$lang}}" aria-expanded="true">
                                                                                            <div class="col-md-12 col-12">
                                                                                                <div class="form-group">
                                                                                                    ...
                                                                                                    <div class="controls">
                                                                                                        <input type="text" name="name[{{$lang}}]" class="form-control" placeholder="{{__('admin.write') . __('admin.name')}} {{ $lang }}" value="{{ $pricePackage->getTranslation('name', $lang) }}" required data-validation-required-message="{{__('admin.this_field_is_required')}}">
                                                                                                    </div>
                                                                                                </div>
                                                                                            </div>
                                                                                            <div class="col-md-12 col-12">
                                                                                                <div class="form-group">
                                                                                                    ...
                                                                                                    <div class="controls">
                                                                                                        <textarea class="form-control" name="description[{{$lang}}]" cols="30" rows="3" placeholder="{{__('admin.write') . __('admin.description')}} {{ $lang }}">{{ $pricePackage->getTranslation('description', $lang) }}</textarea>
                                                                                                    </div>
                                                                                                </div>
                                                                                            </div>
                                                                                        </div>
                                                                                ...
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <div class="controls">
                                                                                        <select name="car_id"
                                                                                            ...
                                                                                            @foreach($cars as $car)
                                                                                                <option value="{{ $car->id }}" {{ $pricePackage->car_id == $car->id ? 'selected' : '' }}>{{ $car->name }}</option>
                                                                                            @endforeach
                                                                                        </select>
                                                                                    </div>
                                                                                </div>
                                                                                ...
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <div class="controls">
                                                                                        <select name="is_unlimited"
                                                                                                ...
                                                                                                data-validation-required-message="{{ __('admin.this_field_is_required') }}">
                                                                                            <option value="">{{ __('admin.select') }}</option>
                                                                                            <option value="0" {{ !$pricePackage->is_unlimited ? 'selected' : '' }}>{{ __('admin.limited') }}</option>
                                                                                            <option value="1" {{ $pricePackage->is_unlimited ? 'selected' : '' }}>{{ __('admin.unlimited') }}</option>
                                                                                        </select>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                                ...
                                                                                <div class="form-group" id="kilometer_limit_group">
                                                                                    ...
                                                                                    <div class="controls">
                                                                                        <input type="number" name="kilometer_limit"
                                                                                               ...
                                                                                               value="{{ $pricePackage->kilometer_limit }}"
                                                                                               min="1">
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                                ...
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <div class="controls">
                                                                                        <select name="is_active"
                                                                                                ...
                                                                                                required
                                                                                                data-validation-required-message="{{ __('admin.this_field_is_required') }}">
                                                                                            <option value="1" {{ $pricePackage->is_active ? 'selected' : '' }}>{{ __('admin.activate') }}</option>
                                                                                            <option value="0" {{ !$pricePackage->is_active ? 'selected' : '' }}>{{ __('admin.dis_activate') }}</option>
                                                                                        </select>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                                ...
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <div class="controls">
                                                                                        <input type="number" name="sort_order"
                                                                                               ...
                                                                                               value="{{ $pricePackage->sort_order }}" min="0">
                                                                                    </div>
                                                                                </div>
                                                                            </div>
