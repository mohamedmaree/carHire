        ...
        @foreach($cities as $city)
            <tr class="delete_city">
                ...
                <td class="product-action">
                    @can('read-city')
                        <span class="text-primary"><a href="{{ route('admin.cities.show', ['city' => $city->id]) }}"
                    ...
                    @can('delete-city')
                        <span class="delete-row btn btn-danger btn-sm"
                              data-url="{{ url('admin/cities/' . $city->id) }}"><i class="feather icon-trash"></i>{{ __('admin.delete') }}</span>
                    @endcan
                </td>
            </tr>
        @endforeach
