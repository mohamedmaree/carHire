...
<x-admin.table 
    ...
    order="true" 
    extrabuttons="true"
    addbutton="{{ route('admin.offers.create') }}"
    deletebutton="{{ route('admin.offers.deleteAll') }}"
    :searchArray="[
        'title' => [
            'input_type' => 'text' , 
        ...
        'discount_amount' => [
            'input_type' => 'number' , 
            'input_name' => __('admin.discount_amount') , 
        ] ,
        'coupon_id' => [
            'input_type' => 'select' , 
            'rows'       => $couponsArray,
            'input_name' => __('admin.coupons.index')  , 
        ] ,
        'is_active' => [
            'input_type' => 'select' , 
            'rows'       => [
...
@section('js')
    ...
    @include('admin.shared.filter_js' , [ 'index_route' => route('admin.offers.index') ])
@endsection