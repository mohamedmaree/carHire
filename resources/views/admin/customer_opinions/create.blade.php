...
@section('content')
<form  method="POST" action="{{route('admin.customer-opinions.store')}}" class="store form-horizontal" novalidate>
                                                                                            ...
                                                                                            <div class="col-md-12 col-12">
                                                                                                <div class="form-group">
                                                                                                    <div class="controls">
                                                                                                        ...
                                                                                                        <input type="text" class="form-control" name="name[{{$lang}}]" placeholder="{{__('admin.write') . __('admin.name')}} {{ $lang }}" required data-validation-required-message="{{__('admin.this_field_is_required')}}">
                                                                                                    </div>
                                                                                                </div>
                                                                                            </div>
                                                                                            <div class="col-12">
                                                                                                <div class="form-group">
                                                                                                    <div class="controls">
                                                                                                        ...
                                                                                                        <textarea class="form-control" name="opinion_text[{{$lang}}]" id="" cols="30" rows="5" placeholder="{{__('admin.write') . __('admin.opinion_text')}} {{ $lang }}" required data-validation-required-message="{{__('admin.this_field_is_required')}}"></textarea>
                                                                                                    </div>
                                                                                                </div>
                                                                                            </div>
                                                                                        </div>
                                                                                    ...
                                                                                    <div class="form-group">
                                                                                        ...
                                                                                        <div class="controls">
                                                                                            <select name="num_stars" id="num_stars" class="form-control" required data-validation-required-message="{{__('admin.this_field_is_required')}}">
                                                                                                ...
                                                                                                <option value="2">2 {{__('admin.stars')}}</option>
                                                                                                <option value="3">3 {{__('admin.stars')}}</option>
                                                                                                <option value="4">4 {{__('admin.stars')}}</option>
                                                                                                <option value="5" selected>5 {{__('admin.stars')}}</option>
                                                                                            </select>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                                ...
                                                                                <div class="col-md-6 col-12">
                                                                                    <div class="form-group">
                                                                                        ...
                                                                                        <div class="custom-control custom-switch custom-switch-success mr-2 mb-1">
                                                                                            <input name="is_active" value="1" type="checkbox" class="custom-control-input" id="customSwitch1" checked>
