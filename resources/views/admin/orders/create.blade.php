                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-md-6 col-12">
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <div class="controls">
                                                                                        <input type="text" name="pickup_address" class="form-control" value="{{old('pickup_address')}}" placeholder="@lang('admin.pickup_address')">
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                                ...
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <div class="controls">
                                                                                        <select name="return_location_id" class="select2 form-control">
                                                                                            ...
                                                                                            @foreach($locations as $location)
                                                                                                <option value="{{$location->id}}" {{old('return_location_id') == $location->id ? 'selected' : ''}}>
                                                                                                    {{$location->name}} ({{$location->type_text}})
                                                                                                </option>
                                                                                            @endforeach
                                                                                        </select>
                                                                            ...
                                                                            <div class="col-md-6 col-12">
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <div class="controls">
                                                                                        <input type="text" name="return_address" class="form-control" value="{{old('return_address')}}" placeholder="@lang('admin.return_address')">
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                                ...
                                                                                <div class="form-group">
                                                                                    <div class="controls">
                                                                                        <label class="form-check-label">
                                                                                            <input type="checkbox" name="same_return_location" value="1" class="form-check-input" {{old('same_return_location') ? 'checked' : ''}}>
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-md-6 col-12">
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <div class="controls">
                                                                                        <input type="date" name="pickup_date" class="form-control" value="{{old('pickup_date')}}" required data-validation-required-message="{{__('admin.this_field_is_required')}}">
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            ...
                                                                            <div class="col-md-6 col-12">
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <div class="controls">
                                                                                        <input type="time" name="pickup_time" class="form-control" value="{{old('pickup_time')}}" required data-validation-required-message="{{__('admin.this_field_is_required')}}">
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            ...
                                                                            <div class="col-md-6 col-12">
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <div class="controls">
                                                                                        <input type="date" name="return_date" class="form-control" value="{{old('return_date')}}" required data-validation-required-message="{{__('admin.this_field_is_required')}}">
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            ...
                                                                            <div class="col-md-6 col-12">
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <div class="controls">
                                                                                        <input type="time" name="return_time" class="form-control" value="{{old('return_time')}}" required data-validation-required-message="{{__('admin.this_field_is_required')}}">
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-md-6 col-12">
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <div class="controls">
                                                                                        <input type="number" name="customer_age" class="form-control" value="{{old('customer_age')}}" min="18" max="100" required data-validation-required-message="{{__('admin.this_field_is_required')}}">
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                                    ...
                                                                                    <div class="controls">
                                                                                        <select name="customer_country_id" class="select2 form-control" required data-validation-required-message="{{__('admin.this_field_is_required')}}">
                                                                                            ...
                                                                                            @foreach($countries as $country)
                                                                                                <option value="{{$country->id}}" {{old('customer_country_id') == $country->id ? 'selected' : ''}}>
                                                                                                    {{$country->name}}
                                                                                                </option>
                                                                                            @endforeach
                                                                                        </select>
                                                                                    ...
                                                                                    <div class="controls">
                                                                                        <select name="price_package_id" class="select2 form-control" required data-validation-required-message="{{__('admin.this_field_is_required')}}">
                                                                                            ...
                                                                                            @foreach($pricePackages as $package)
                                                                                                <option value="{{$package->id}}" {{old('price_package_id') == $package->id ? 'selected' : ''}}>
                                                                                                    ...
                                                                                                    <div class="card option-card">
                                                                                                        <div class="card-body">
                                                                                                            ...
                                                                                                            <div class="input-group">
                                                                                                                <input type="number" name="options[{{$option->id}}][quantity]" class="form-control" min="0" value="{{old('options.'.$option->id.'.quantity', 0)}}" placeholder="0">
                                                                            ...
                                                                            <div class="col-md-6 col-12">
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <div class="controls">
                                                                                        <input type="text" name="coupon_code" class="form-control" value="{{old('coupon_code')}}" placeholder="@lang('admin.coupon_code')">
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            ...
                                                                            <div class="col-md-6 col-12">
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <div class="controls">
                                                                                        <input type="number" name="fees" class="form-control" value="{{old('fees')}}" placeholder="@lang('admin.fees')" step="0.01" min="0">
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-md-6 col-12">
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <div class="controls">
                                                                                        <input type="text" name="first_name" class="form-control" value="{{old('first_name')}}" required data-validation-required-message="{{__('admin.this_field_is_required')}}">
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            ...
                                                                            <div class="col-md-6 col-12">
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <div class="controls">
                                                                                        <input type="text" name="last_name" class="form-control" value="{{old('last_name')}}" required data-validation-required-message="{{__('admin.this_field_is_required')}}">
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            ...
                                                                            <div class="col-md-6 col-12">
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <div class="controls">
                                                                                        <input type="email" name="email" class="form-control" value="{{old('email')}}" required data-validation-required-message="{{__('admin.this_field_is_required')}}">
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            ...
                                                                            <div class="col-md-6 col-12">
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <div class="controls">
                                                                                        <input type="text" name="phone" class="form-control" value="{{old('phone')}}" required data-validation-required-message="{{__('admin.this_field_is_required')}}">
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            ...
                                                                            <div class="col-md-12 col-12">
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <div class="controls">
                                                                                        <input type="date" name="driver_license_expiration_date" class="form-control" value="{{old('driver_license_expiration_date')}}">
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            ...
                                                                            <div class="col-md-6 col-12">
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <div class="controls">
                                                                                        <textarea name="current_country_address" class="form-control" rows="3">{{old('current_country_address')}}</textarea>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            ...
                                                                            <div class="col-md-12 col-12">
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <div class="controls">
                                                                                        <input type="date" name="passport_expiration_date" class="form-control" value="{{old('passport_expiration_date')}}">
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        ...
                                                                        <div class="row">
                                                                                    ...
                                                                                    <div class="controls">
                                                                                        <select name="order_status" class="select2 form-control">
                                                                                            @foreach(\App\Enums\OrderStatus::getOptions() as $value => $label)
                                                                                                <option value="{{$value}}" {{old('order_status', 'pending') == $value ? 'selected' : ''}}>{{$label}}</option>
                                                                                            @endforeach
                                                                                        </select>
                                                                                    </div>
                                                                                </div>
                                                                                ...
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <div class="controls">
                                                                                        <select name="is_active" class="select2 form-control" required data-validation-required-message="{{__('admin.this_field_is_required')}}">
                                                                                            <option value="1">@lang('admin.activate')</option>
                                                                                            <option value="0">@lang('admin.dis_activate')</option>
                                                                                        </select>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            ...
                                                                            <div class="col-md-6 col-12">
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <div class="controls">
                                                                                        <input type="number" name="sort_order" class="form-control" placeholder="@lang('admin.sort_order')" value="0" min="0">
                                                                                    </div>
                                                                                </div>
                                                                            </div>

                                                                            <div class="col-12 d-flex justify-content-center mt-3">
                                                                                <button type="submit" class="btn btn-primary mr-1 mb-1 submit_button">@lang('admin.add')</button>
