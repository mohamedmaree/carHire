...
trait UploadTrait {
  ...
  public function uploadAllTyps($file , $directory , $width = null , $height = null)
  {
      ...
      if ($imageCheck[0] == 'image' && $file->getClientOriginalExtension() != 'svg') {
      ...
      $allowedMimeTypes = ['application/pdf'  ,'application/msword' , 'application/excel','application/vnd.ms-excel','application/vnd.msexcel','application/vnd.openxmlformats-officedocument.spreadsheetml.sheet'  ,'application/octet-stream','audio/3gpp','video/quicktime','audio/m4a','audio/aac','video/mp4','audio/mp4','image/svg+xml'] ; 
